...
EN = {
  ...
  "desc": "One file, AGENTS.md: a stance, an evidence rule, and an eight-step loop from explore to report. Symlink it into Claude Code, Codex CLI, Gemini CLI, OpenCode, and pi.",
  "lede": 'The operating contract I hand every coding agent. <b>One file, <code>AGENTS.md</code></b>: a stance, an evidence rule, and an eight-step loop from explore to report.',
  ...
  "s2lead": "Explore to report. Step five is the only place the agent stops for a human.",
  "steps": [
...
KO = dict(EN, **{
  ...
  "desc": "파일 하나, AGENTS.md. 태도와 증거 규칙, 그리고 explore에서 report까지 이어지는 8단계 루프가 들어 있다. Claude Code·Codex CLI·Gemini CLI·OpenCode·pi에 심링크로 걸어 쓴다.",
  "lede": '내가 쓰는 모든 코딩 에이전트에 똑같이 걸어 두는 운영 계약. <b>파일 하나, <code>AGENTS.md</code></b>에 태도와 증거 규칙, explore에서 report까지의 8단계 루프가 들어 있다.',
  ...
  "s2": "8단계 루프",
  "s2lead": "explore에서 report까지 이어진다. 에이전트가 사람을 기다리는 곳은 5단계 하나뿐이다.",
  "steps": [
